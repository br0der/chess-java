...
public class main extends PApplet {
    ...
    public void setup(){
        // 1280, 427
        noStroke();
        pieces = loadImage("sprites.png");
        wKing = pieces.get(0,213,213,213);
        wQueen = pieces.get(214,213,213,213);
        wBishop = pieces.get(427,213,213,213);
        wKnight = pieces.get(640,213,213,213);
        wRook = pieces.get(853,213,213,213);
        wPawn = pieces.get(1066,213,213,213);
        bKing = pieces.get(0,213,213,213);
        bQueen = pieces.get(214,213,213,213);
        bBishop = pieces.get(427,213,213,213);
        bKnight = pieces.get(640,213,213,213);
        bRook = pieces.get(853,213,213,213);
        bPawn = pieces.get(1066,213,213,213);
    }
